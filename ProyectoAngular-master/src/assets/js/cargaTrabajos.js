...
let cargarJson = () => {
  ...
  fetch('https://raw.githubusercontent.com/RicardoVilcacundo/ProyectoDAWM/main/BizLand/assets/json/especiales.json')
  .then( (resultado) => {
  ...
  .then( (data) => {
	...
	dtitulo.textContent = data.especial[0].titulo;
	let dsubtitulo = document.createElement("h3");
	let dspan = document.createElement("span");
	dspan.textContent = data.especial[0].subtitulo;
	dsubtitulo.appendChild(dspan);
	let parrafo1 = document.createElement("p");
	let parrafo2 = document.createElement("p");
	parrafo1.textContent = data.especial[0].descripcion1;
	parrafo2.textContent = data.especial[0].descripcion2;
	...
	dinformacion.textContent = data.especial[1].informacion;
	
	//Creacion de lista
	let dlista = document.createElement("ul");
	for(let elemento of data.especial[1].lista){
