...
.then((data)=>{
    ...
    for ( var texto of data.consultoria.financiera.descripcion){
    ...
    for ( var texto2 of data.consultoria.tributaria.descripcion){
        let Tp= document.createElement("p");   
    ...
    for (var  texto3 of data.consultoria.laboral.descripcion){
        let Tp= document.createElement("p");   
